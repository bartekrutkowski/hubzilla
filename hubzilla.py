...
def index():
    if request.method == 'POST':
        ...
        comment_pull_request = request.post(
            ...
            data='{"body": "This repository is a read only mirror of official FreeBSD SVN repository. Your pull-request has been transferred into FreeBSD bug tracker here: https://bugs.freebsd.org/bugzilla//show_bug.cgi?id={problem_report_id} where you can work with the FreeBSD community on it. This pull request is closed automatically."}'.format(problem_report_id=problem_report.id))
